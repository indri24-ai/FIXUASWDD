...
<main>
  ...
  <section class="ceo-section">
    <div class="profile">
      <img src="imgourteam/cecep.jpg" alt="CEO Cahya" class="ceo-photo" />
      <p class="ceo-role">CEO</p>
      <h2 class="ceo-name">Cahya</h2>
    </div>
    ...
    <div class="description">
      ...
      <section class="team-grid">
        <div class="team-member">
          <img src="imgourteam/ambar.png" alt="Ambar" />
          <p class="position">MANAGER</p>
          <p class="name"><strong>Ambar</strong></p>
        </div>
        <div class="team-member">
          <img src="imgourteam/pritii.png" alt="Prety" />
          <p class="position">RESOURCE MANAGER</p>
          <p class="name"><strong>Prety</strong></p>
        </div>
      </section>
      ...
      <section class="team-grid">
        ...
        <div class="team-member">
          <img src="imgourteam/indri.png" alt="Indri" />
          <p class="position">CUSTOMER SUPPORT</p>
          <p class="name"><strong>Indri</strong></p>
        </div>
        <div class="team-member">
          <img src="imgourteam/aldin.png" alt="Aldin" />
          <p class="position">STAFF</p>
          <p class="name"><strong>Aldin</strong></p>
        </div>
            </section>
            </main>
